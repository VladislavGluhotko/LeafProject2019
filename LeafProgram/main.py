...
def main(traindatapath,validationdatapath,rastersarray_save_name,labelssarray_save_name,model_save_name,rastersize,maxarraysizeGB,testsize,predictions_topN,mode1="new",mode2="new"):
	...
	if mode2 == "load":
		...
		model.add(tf.keras.layers.Conv2D(32,(3,3),input_shape=(rastersize,rastersize,3),activation='relu'))
		...
		# Обучение модели:
		model.fit(rasters_train, to_categorical(labels_train), batch_size=50, nb_epoch=100, validation_split=0.0, shuffle=False)
